            ...
            if (is_empty(modelCtrl.$modelValue)) return scope.header = attrs.msHeader || 'Select';
              ...
              if (isMultiple) {
                  if (attrs.msSelected) {
                      ...
                      var header = '';
                      angular.forEach(modelCtrl.$modelValue, function(value) {
                          header = header + value.Name + ', ';
                      });
                      scope.header = header.substr(0, header.length - 2);
                  }
...
angular.module('multiselect.tpl.html', [])
  ...
  .run(['$templateCache', function($templateCache) {
    $templateCache.put('multiselect.tpl.html',
      ...
      "  <button type=\"button\" class=\"btn btn-default dropdown-toggle\" ng-click=\"toggleSelect()\" ng-disabled=\"disabled\" ng-class=\"{'error': !valid()}\" style=\"width: 100%\">\n" +
